...
expName = 'TUTORIAL 0.1'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Visha\\Desktop\\PSY310\\TUTORIAL 0.1.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    while continueRoutine and routineTimer.getTime() < 1.0:
        ...
        if text2.status == STARTED:
            ...
            if tThisFlip > 1.0-frameTolerance:
                ...
                text2.tStopRefresh = tThisFlipGlobal  # on global time
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('C:/Users/Visha/Desktop/310 excel/cond.xlsx'), 
        seed=None, 
        isTrials=True, 
    )
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[fixation, text, key_resp],
        )
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['r','b'], ignoreKeys=["escape"], waitRelease=False)
    ...
    while continueRoutine and routineTimer.getTime() < 1.0:
        ...
        if text3.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
        ...
        if text3.status == STARTED:
            ...
            if tThisFlip > 1-frameTolerance:
                ...
                text3.tStopRefresh = tThisFlipGlobal  # on global time
